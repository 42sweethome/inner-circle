...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/05/23 12:35:55 by daekim            #+#    #+#             */
/*   Updated: 2021/05/23 12:35:57 by daekim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		apply_comm2(t_link *st_a, t_link *st_b, t_info *info, char *comm)
{
	...
	else if (ft_strncmp(comm, "pa", 3) == 0)
...
int		apply_comm(t_link *st_a, t_link *st_b, t_info *info, char *comm)
{
	...
	if (ft_strncmp(comm, "sa", 3) == 0)
		...
		ret = func_ss(st_a, st_b, info);
	else if (ft_strncmp(comm, "rra", 4) == 0)
