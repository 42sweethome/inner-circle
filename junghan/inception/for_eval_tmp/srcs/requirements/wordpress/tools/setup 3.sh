...
if  [ ! -f /var/www/wordpress/wp-config.php ]; then 
    ...
    wp core install --allow-root --url='junghan.42.fr' --title='Welcome to Inception' --admin_user=${WP_ID} --admin_password=${WP_PW}  --admin_email="junghan@student.42seoul.kr" --path='/var/www/wordpress';
