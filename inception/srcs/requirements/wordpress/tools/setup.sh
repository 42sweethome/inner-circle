...
if  [ ! -f /var/www/wordpress/wp-config.php ]; then 
    ...
    wp core install --allow-root --url='localhost' --title='Welcome to doyun`s Inception' --admin_user=${WP_ID} --admin_password=${WP_PW}  --admin_email="doyun@student.42seoul.kr" --path='/var/www/wordpress';
